...
class SemiSupervisedKMeans:
    ...
    def initialize(self, data, labels):
        ...
        data_with_labels = np.insert(data, 0, labels, axis=1)
    ...
    def fit(self, unlabeled_data, threshold):
        ...
        while diff != 0:
            ...
            data_copy = np.delete(data_copy, delete_from_unlabeled, axis=0)
        ...
        print('len unlabeled: %s ' % len(unlabeled_data))
